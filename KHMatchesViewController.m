...
#import "KHMatchesViewController.h"
#import "KHChatViewController.h"

@interface KHMatchesViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation KHMatchesViewController
...
- (void)viewDidLoad
{
    ...
    // Set the delegate and datasource of our tableView
...
{
    KHChatViewController *chatVC = segue.destinationViewController;
...
// Helper method to get all the available chatRooms
- (void)updateAvailableChatRooms
{
    ...
    // Download not only the chatroom, but also the chat and user objects
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Figure out which user is the current user and which user is the liked user.
