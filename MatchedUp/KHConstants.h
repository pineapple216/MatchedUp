...
extern NSString *const kKHMenEnabledKey;
extern NSString *const kKHWomenEnabledKey;
extern NSString *const kKHSingleEnabledKey;
extern NSString *const kKHMaxAgeKey;
